...
class font():
    def __init__(self, game_win, font_png, font_color="white", font_table=[]):
        ...
        self.spacing = {"A":(1, 0, 2, 0), "B":(1, 0, 2, 0), "C":(1, 0, 2, 0), "D":(1, 0, 2, 0), "E":(1, 0, 2, 0), "F":(1, 0, 2, 0),
                        ...
                        "S":(1, 0, 0, 0), "T":(1, 0, 1, 0), "U":(1, 0, 0, 0), "V":(1, 0, 0, 0), "W":(0, 0, 1, 0), "X":(1, 0, 0, 0),
                        "Y":(1, 0, 0, 0), "Z":(1, 0, 0, 0), "a":(1, 0, 1, 0), "b":(1, 0, 0, 0), "c":(1, 0, 0, 0), "d":(1, 0, 0, 0),
                        "e":(1, 0, 2, 0), "f":(1, 0, 3, 0), "g":(1, 0, 0, 0), "h":(1, 0, 0, 0), "i":(0, 0, 6, 0), "j":(1, 0, 0, 0),
                        "k":(0, 0, 4, 0), "l":(0, 0, 4, 0), "m":(0, 0, 0, 0), "n":(0, 0, 3, 0), "o":(0, 0, 3, 0), "p":(1, 0, 0, 0),
                        "q":(1, 0, 0, 0), "r":(1, 0, 2, 0), "s":(2, 0, 1, 0), "t":(2, 0, 2, 0), "u":(1, 0, 0, 0), "v":(2, 0, 2, 0),
                        "w":(0, 0, 1, 0), "x":(2, 0, 2, 0), "y":(2, 0, 2, 0), "z":(2, 0, 2, 0), "1":(1, 0, 2, 0), "2":(1, 0, 1, 0),
